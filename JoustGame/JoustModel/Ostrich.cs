...
namespace JoustModel
{
    public class Ostrich : Entity
    {
        ...
        {
            return string.Format("Ostrich,{0},{1},{2},{3},{4},{5},{6},{7}", score, lives, speed, angle, coords.x, coords.y, acceleration, accelerationAngle);
        }
        ...
        public override void Deserialize(string data)
        {
            ...
            acceleration = Convert.ToDouble(properties[7]); // set acceleration
            accelerationAngle = Convert.ToDouble(properties[8]); // set accelerationAngle
        }
    }
